...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[(4, 'Conocer el orígen de las materias primas'), (5, 'No soy proveedor de MATERIA ORGANICA'), (1, 'Registro de los productos en Agrocalidad o MAGAP'), (2, 'Fichas técnicas y hojas de seguridad de los productos empleados'), (3, 'Análisis físico-químico y microbiológico de la M.O. (vigencia 1 año)')], max_length=300, null=True),
        ),
        migrations.AlterField(
            model_name='proveedor_det',
        ...
        migrations.AlterField(
            ...
            name='seccion',
            field=models.CharField(blank=True, choices=[(10, 'Fundas/Rollos'), (19, 'Laboratorios de calibracion'), (21, 'Materia Prima'), (31, 'Buenas prracticas de  responsabilidad social'), (9, 'Información de la relacion comercial con Ecofroz'), (7, 'Requisitos persona Natural'), (2, 'Codigo de Etica'), (28, 'Buenas practicas de calidad'), (26, 'Korex - Sleep Shipt'), (8, 'Requisitos Persona Juridica'), (24, 'Transporte de contenedores'), (15, 'Cajas'), (17, 'Laboratorios de Analisis'), (27, 'Transporte'), (23, 'Grados de grado alimenticio'), (22, 'Quimicos para el caldero'), (13, 'Quimicos de limpieza (Detergentes)'), (33, 'Buenas practicas con proveedores y clientes'), (6, 'Existencia y Legalidad'), (11, 'Control de Plagas'), (16, 'Catering'), (18, 'Materiales de laboratorio (insumos)'), (12, 'Centros de acopio'), (14, 'Quimicos de limpieza (Desinfectantes)'), (3, 'Licitud de Fondos'), (29, 'Buenas practicas de seguridad'), (20, 'Gestores ambientales de desechos'), (25, 'Transporte maritimo (navieras)'), (30, 'Buenas practicas ambientales'), (5, 'Información General'), (4, 'Veracidad de las respuestas'), (32, 'Buenas practicas laborales'), (34, 'Retroalimentacion Ecofroz'), (1, 'Fecha de elaboración')], max_length=200, null=True),
        ),
    ]
