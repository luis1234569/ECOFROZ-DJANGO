# Generated by Django 3.0.8 on 2020-08-22 16:23
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('proveedores', '0051_auto_20200821_1836'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='seccion',
            field=models.CharField(blank=True, choices=[(3, 'Licitud de Fondos'), (18, 'Materiales de laboratorio (insumos)'), (16, 'Catering'), (21, 'Materia Prima'), (23, 'Grados de grado alimenticio'), (27, 'Transporte'), (31, 'Buenas prracticas de  responsabilidad social'), (5, 'Información General'), (29, 'Buenas practicas de seguridad'), (24, 'Transporte de contenedores'), (7, 'Requisitos persona Natural'), (20, 'Gestores ambientales de desechos'), (34, 'Retroalimentacion Ecofroz'), (12, 'Centros de acopio'), (28, 'Buenas practicas de calidad'), (11, 'Control de Plagas'), (13, 'Quimicos de limpieza (Detergentes)'), (2, 'Codigo de Etica'), (6, 'Existencia y Legalidad'), (19, 'Laboratorios de calibracion'), (33, 'Buenas practicas con proveedores y clientes'), (8, 'Requisitos Persona Juridica'), (32, 'Buenas practicas laborales'), (15, 'Cajas'), (14, 'Quimicos de limpieza (Desinfectantes)'), (22, 'Quimicos para el caldero'), (1, 'Fecha de elaboración'), (17, 'Laboratorios de Analisis'), (26, 'Korex - Sleep Shipt'), (25, 'Transporte maritimo (navieras)'), (30, 'Buenas practicas ambientales'), (10, 'Fundas/Rollos'), (9, 'Información de la relacion comercial con Ecofroz'), (4, 'Veracidad de las respuestas')], max_length=200, null=True),
        ),
    ]
