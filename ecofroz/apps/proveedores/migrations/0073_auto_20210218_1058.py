# Generated by Django 3.0 on 2021-02-18 15:58
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('proveedores', '0072_auto_20210217_1325'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='seccion',
            field=models.CharField(blank=True, choices=[(5, 'Información General'), (9, 'Información de la relacion comercial con Ecofroz'), (24, 'Transporte de contenedores'), (3, 'Licitud de Fondos'), (4, 'Veracidad de las respuestas'), (12, 'Centros de acopio'), (16, 'Catering'), (32, 'Buenas practicas laborales'), (14, 'Quimicos de limpieza (Desinfectantes)'), (20, 'Gestores ambientales de desechos'), (34, 'Retroalimentacion Ecofroz'), (25, 'Transporte maritimo (navieras)'), (22, 'Quimicos para el caldero'), (8, 'Requisitos Persona Juridica'), (33, 'Buenas practicas con proveedores y clientes'), (27, 'Transporte'), (28, 'Buenas practicas de calidad'), (26, 'Korex - Sleep Shipt'), (19, 'Laboratorios de calibracion'), (2, 'Codigo de Etica'), (23, 'Grados de grado alimenticio'), (17, 'Laboratorios de Analisis'), (30, 'Buenas practicas ambientales'), (13, 'Quimicos de limpieza (Detergentes)'), (15, 'Cajas'), (31, 'Buenas prracticas de  responsabilidad social'), (7, 'Requisitos persona Natural'), (6, 'Existencia y Legalidad'), (29, 'Buenas practicas de seguridad'), (11, 'Control de Plagas'), (1, 'Fecha de elaboración'), (21, 'Materia Prima'), (18, 'Materiales de laboratorio (insumos)'), (10, 'Fundas/Rollos')], max_length=200, null=True),
        ),
    ]
