# Generated by Django 3.0 on 2020-03-04 17:50
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('proveedores', '0008_auto_20200304_1152'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(blank=True, choices=[(5, 'Los ingredientes activos vigentes en las legislaciones de USA, Japón, Europa'), (7, 'No soy proveedor de fertilizantes'), (2, 'Fichas técnicas y hojas de seguridad de los productos empleados'), (1, 'Registro de los productos en Agrocalidad o MAGAP'), (3, 'Análisis de metales pesados'), (4, 'Certificado de que esta libre de noni fenol y cloruro de benzalconio'), (6, 'Conocer el orígen de las materias primas')], max_length=300, null=True),
        ),
        migrations.AddField(
            model_name='proveedor_det',
