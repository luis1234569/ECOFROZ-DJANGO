# Generated by Django 3.0.7 on 2021-05-25 19:34
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('proveedores', '0112_auto_20210521_1100'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='proveedor',
            options={'managed': True, 'ordering': ['-fecha_modifica'], 'permissions': (('acceso_proveedores', 'Acceso Menu Proveedores'), ('acceso_provisional', 'Acceso Provicional Proveedores'), ('acceso_rev_calidad', 'Acceso Revisión Proveedores Calidad'), ('acceso_auditorias', 'Acceso Auditorias'))},
        ),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[(7, 'No soy proveedor de fertilizantes'), (1, 'Registro de los productos en Agrocalidad o MAGAP'), (2, 'Fichas técnicas y hojas de seguridad de los productos empleados'), (3, 'Análisis de metales pesados'), (4, 'Certificado de que esta libre de noni fenol y cloruro de benzalconio'), (6, 'Conocer el orígen de las materias primas'), (5, 'Los ingredientes activos vigentes en las legislaciones de USA, Japón, Europa')], max_length=300, null=True),
        ),
        migrations.AlterField(
            model_name='historicalproveedor_det',
        ...
        migrations.AlterField(
            ...
            name='seccion',
            field=models.CharField(blank=True, choices=[(20, 'Gestores ambientales de desechos'), (17, 'Laboratorios de Analisis'), (34, 'Retroalimentacion Ecofroz'), (15, 'Cajas'), (28, 'Buenas practicas de calidad'), (3, 'Licitud de Fondos'), (14, 'Quimicos de limpieza (Desinfectantes)'), (32, 'Buenas practicas laborales'), (10, 'Fundas/Rollos'), (13, 'Quimicos de limpieza (Detergentes)'), (1, 'Fecha de elaboración'), (9, 'Información de la relacion comercial con Ecofroz'), (31, 'Buenas prracticas de  responsabilidad social'), (11, 'Control de Plagas'), (5, 'Información General'), (30, 'Buenas practicas ambientales'), (4, 'Veracidad de las respuestas'), (7, 'Requisitos persona Natural'), (18, 'Materiales de laboratorio (insumos)'), (2, 'Codigo de Etica'), (19, 'Laboratorios de calibracion'), (25, 'Transporte maritimo (navieras)'), (23, 'Grados de grado alimenticio'), (24, 'Transporte de contenedores'), (26, 'Korex - Sleep Shipt'), (12, 'Centros de acopio'), (22, 'Quimicos para el caldero'), (8, 'Requisitos Persona Juridica'), (16, 'Catering'), (6, 'Existencia y Legalidad'), (33, 'Buenas practicas con proveedores y clientes'), (27, 'Transporte'), (21, 'Materia Prima'), (29, 'Buenas practicas de seguridad')], max_length=200, null=True),
        ),
        migrations.AlterField(
