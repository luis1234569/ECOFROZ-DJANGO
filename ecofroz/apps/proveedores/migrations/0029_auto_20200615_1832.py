# Generated by Django 3.0 on 2020-06-15 23:32
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('proveedores', '0028_auto_20200615_1831'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            name='proveedor_id',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='proveedores.proveedor'),
        ),
        ...
        migrations.AlterField(
            ...
            name='seccion',
            field=models.CharField(blank=True, choices=[(28, 'Buenas practicas de calidad'), (7, 'Requisitos persona Natural'), (27, 'Transporte'), (5, 'Información General'), (33, 'Buenas practicas con proveedores y clientes'), (1, 'Fecha de elaboración'), (25, 'Transporte maritimo (navieras)'), (18, 'Materiales de laboratorio (insumos)'), (12, 'Centros de acopio'), (11, 'Control de Plagas'), (21, 'Materia Prima'), (13, 'Quimicos de limpieza (Detergentes)'), (15, 'Cajas'), (2, 'Codigo de Etica'), (8, 'Requisitos Persona Juridica'), (16, 'Catering'), (24, 'Transporte de contenedores'), (3, 'Licitud de Fondos'), (19, 'Laboratorios de calibracion'), (20, 'Gestores ambientales de desechos'), (10, 'Fundas/Rollos'), (23, 'Grados de grado alimenticio'), (31, 'Buenas prracticas de  responsabilidad social'), (29, 'Buenas practicas de seguridad'), (34, 'Retroalimentacion Ecofroz'), (6, 'Existencia y Legalidad'), (17, 'Laboratorios de Analisis'), (32, 'Buenas practicas laborales'), (22, 'Quimicos para el caldero'), (4, 'Veracidad de las respuestas'), (9, 'Información de la relacion comercial con Ecofroz'), (14, 'Quimicos de limpieza (Desinfectantes)'), (30, 'Buenas practicas ambientales'), (26, 'Korex - Sleep Shipt')], max_length=200, null=True),
        ),
    ]
