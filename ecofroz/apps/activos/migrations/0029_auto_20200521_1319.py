...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('activos', '0028_auto_20200514_1558'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[('cambio_caracteristicas', 'Cambio de Caracteristicas'), ('cambio_ubicacion', 'Cambio de Ubicación'), ('actualiza_asegurado', 'Cambio valor Asegurado'), ('cambio_custodio', 'Cambio de Custodio'), ('cambio_estado', 'Cambio de Estado')], max_length=50, null=True),
        ),
        migrations.AlterField(
